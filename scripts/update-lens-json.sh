...
# Script to encode lab-lens.js to base64 and update lab-lens.json

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"

JS_FILE="$PROJECT_DIR/lab-lens.js"
JSON_FILE="$PROJECT_DIR/lab-lens.json"
...
console.log('✅ Updated lab-lens.json with encoded JS');
"
